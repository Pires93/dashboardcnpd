...
@if($pedido) 
    ...
    <div class="col-md-12" id="right"><b>Criado em:</b> {{ $pedido->created_at }}</div>  
        ...
        <div class="col-md-12"><br></div>
        <div class="col-md-12" id="cabecalho">
            2. Carateristicas do Sistema
        </div>
        <div class="col-md-12"><br></div>
        <div class="col-md-3" id="name"> Nº total de Câmaras:</div>
        <div class="col-md-9" id="descricao">{{ $pedido->numero_camaras }}</div>
        <div class="col-md-3" id="name"> Quem tem acesso as imagens em tempo real:</div>
        <div class="col-md-9" id="descricao">{{ $pedido->quem_tem_acesso_imagens }}</div>
        <div class="col-md-3" id="name"> Local para onde e realizada a transmissão:</div>
